...
def test_kpa_to_psi():
    """Test kPa to PSI conversion with various values"""
    assert kpa_to_psi(0.0) == approx(0.0, abs=0.001)
    assert kpa_to_psi(1.0) == approx(0.145038, abs=0.001)
    assert kpa_to_psi(10.0) == approx(1.45038, abs=0.001)
    assert kpa_to_psi(100.0) == approx(14.5038, abs=0.001)
    assert kpa_to_psi(6.89476) == approx(1.0, abs=0.001)  # 1 psi = 6.89476 kPa
    assert kpa_to_psi(158.7) == approx(23.015, abs=0.001)
    assert kpa_to_psi(500.0) == approx(72.519, abs=0.001)
